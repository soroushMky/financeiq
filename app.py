...
def ai_chat():
    try:
        ...
        context = f"""
You are FinanceIQ, a personal AI financial coach. You are helpful, encouraging, and specific.
...
Reference specific numbers from their data. Be encouraging but honest.
When asked about specific months, use the Monthly Spending Totals above.
"""
